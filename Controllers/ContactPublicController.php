...
class ContactPublicController extends AbstractController
{
    ...
    private array $blacklisted_domains = [
        ...
        '2prong.com', '30minutemail.com', '33mail.com', '3mail.ga', '4mail.cf',
        '4mail.ga', '4mail.ml', '5mail.cf', '5mail.ga', '5mail.ml',
        '6mail.cf', '6mail.ga', '6mail.ml', '7mail.ga', '7mail.ml',
        '9mail.cf', '9mail.ga', '9mail.ml', 'a-bc.net', 'a45.in',
        'a54pd15c.com', 'a-bc.net', 'anonbox.net', 'anonymbox.com', 'antichef.net',
        'antispam.de', 'baxomale.ht.cx', 'beefmilk.com', 'binkmail.com', 'bio-muesli.net',
        'bobmail.info', 'bodhi.lawlita.com', 'bofthew.com', 'boun.cr', 'bouncr.com',
        'breakthru.com', 'bsnow.net', 'bugmenot.com', 'bumpymail.com', 'casualdx.com',
        'centermail.com', 'centermail.net', 'chogmail.com', 'clrmail.com', 'cmail.net',
        'consumerriot.com', 'courriel.fr.nf', 'courrieltemporaire.com', 'curryworld.de', 'dacoolest.com',
        ...
        'discardmail.com', 'discardmail.de', 'disposableaddress.com', 'disposableemailaddresses.com', 'disposableemailaddresses:emailmiser.com',
        'disposeamail.com', 'dispostable.com', 'dm.w3internet.co.uk', 'dodgeit.com', 'dodgit.com',
        'dodgit.org', 'dontreg.com', 'dontsendmespam.de', 'dump-email.info', 'dumpandjunk.com',
        ...
        'emailtemporanea.net', 'emailtemporario.com.br', 'emailthe.net', 'emailtmp.com', 'emailto.de',
        ...
        'fakeinbox.com', 'fakeinformation.com', 'fansworldwide.de', 'fantasymail.de', 'fastacura.com',
        ...
        'fightallspam.com', 'fizmail.com', 'fleckens.hu', 'fr33mail.info', 'frapmail.com',
        ...
        'getonemail.net', 'girlsundertheinfluence.com', 'gishpuppy.com', 'gmial.com', 'goemailgo.com',
        'gotmail.net', 'gotmail.org', 'gotti.otherinbox.com', 'great-host.in', 'greensloth.com',
        ...
        'guerrillamail.net', 'guerrillamail.org', 'guerrillamailblock.com', 'haltospam.com', 'hatespam.org',
        'herp.in', 'hidemail.de', 'hidzz.com', 'hochsitze.com', 'hopemail.biz',
        'ieh-mail.de', 'imap.cc', 'inbax.tk', 'inbox.si', 'inboxalias.com',
        'inboxclean.com', 'inboxclean.org', 'infocom.zp.ua', 'instant-mail.de', 'ipoo.org',
        'irish2me.com', 'iwi.net', 'jetable.com', 'jetable.fr.nf', 'jetable.net',
        'jetable.org', 'jnxjn.com', 'jourrapide.com', 'jsrsolutions.com', 'kasmail.com',
        'kaspop.com', 'killmail.com', 'killmail.net', 'kir.ch.tc', 'klassmaster.com',
        'klassmaster.net', 'klzlk.com', 'koszmail.pl', 'kurzepost.de', 'lifebyfood.com',
        'link2mail.net', 'litedrop.com', 'lol.ovpn.to', 'lookugly.com', 'lopl.co.cc',
        'lortemail.dk', 'lr7.us', 'm4ilweb.info', 'mail-filter.com', 'mail-temporaire.fr',
        'mail.by', 'mail.mezimages.net', 'mail.zp.ua', 'mail1a.de', 'mail21.cc',
        'mail2rss.org', 'mail333.com', 'mailbidon.com', 'mailblocks.com', 'mailbucket.org',
        'mailcat.biz', 'mailcatch.com', 'mailde.de', 'mailde.info', 'maildrop.cc',
        'maileater.com', 'mailed.in', 'mailexpire.com', 'mailfa.tk', 'mailforspam.com',
        'mailfreeonline.com', 'mailguard.me', 'mailin8r.com', 'mailinater.com', 'mailinator.co.uk',
        'mailinator.com', 'mailinator.net', 'mailinator.org', 'mailinator.us', 'mailinator2.com',
        'mailincubator.com', 'mailismagic.com', 'mailme.lv', 'mailme24.com', 'mailmetrash.com',
        'mailmoat.com', 'mailms.com', 'mailna.biz', 'mailna.co', 'mailna.in',
        'mailnesia.com', 'mailnull.com', 'mailorc.com', 'mailorg.org', 'mailpick.biz',
        'mailrock.biz', 'mailscrap.com', 'mailshell.com', 'mailsiphon.com', 'mailslapping.com',
        'mailtemp.info', 'mailtothis.com', 'mailzilla.com', 'mailzilla.org', 'mailzilla.orgmbx.cc',
        'makemetheking.com', 'mbx.cc', 'mega.zik.dj', 'meinspamschutz.de', 'meltmail.com',
        ...
        'mt2014.com', 'mx0.wwwnew.eu', 'mycleaninbox.net', 'mytrashmail.com', 'neomailbox.com',
        'nepwk.com', 'nervmich.net', 'nervtmich.net', 'netmails.net', 'netmails.org',
        'neverbox.com', 'nice-4u.com', 'nincsmail.hu', 'no-spam.ws', 'nobulk.com',
        'nobuma.com', 'noclickemail.com', 'nodezine.com', 'nogmailspam.info', 'nomail.xl.cx',
        'nomail2me.com', 'nomorespamemails.com', 'nonspammer.de', 'nospam.wins.com.br', 'nospam.ze.tc',
        'nospam4.us', 'nospamfor.us', 'nospammail.net', 'nospamthanks.info', 'notmailinator.com',
        'notsharingmy.info', 'nowhere.org', 'nowmymail.com', 'ntlhelp.net', 'nullbox.info',
        ...
        'ovpn.to', 'owlpic.com', 'pancakemail.com', 'pepbot.com', 'pfui.ru',
        'plexolan.de', 'poczta.onet.pl', 'politikerclub.de', 'pookmail.com', 'privacy.net',
        'privatdemail.net', 'proxymail.eu', 'prtnx.com', 'putthisinyourspamdatabase.com', 'qq.com',
        'quickinbox.com', 'rcpt.at', 'reallymymail.com', 'recode.me', 'recursor.net',
        'reliable-mail.com', 'rhyta.com', 'rmqkr.net', 'royal.net', 'rppkn.com',
        'rtrtr.com', 'safe-mail.net', 'safersignup.de', 'safetymail.info', 'safetypost.de',
        ...
        'slave-auctions.net', 'slopsbox.com', 'smellfear.com', 'snakemail.com', 'sneakemail.com',
        ...
        'spambog.de', 'spambog.ru', 'spambooger.com', 'spambox.info', 'spambox.us',
        'spamcannon.com', 'spamcannon.net', 'spamcon.org', 'spamcorptastic.com', 'spamcowboy.com',
        'spamcowboy.net', 'spamcowboy.org', 'spamday.com', 'spamdecoy.net', 'spamdel.com',
        'spamdonkey.com', 'spamfree.eu', 'spamfree24.com', 'spamfree24.de', 'spamfree24.eu',
        ...
        'spamify.com', 'spaml.com', 'spaml.de', 'spamlot.net', 'spamluv.com',
        ...
        'speed.1s.fr', 'spoofmail.de', 'stuffmail.de', 'suremail.info', 'talkinator.com',
        'teewars.org', 'teleworm.com', 'teleworm.us', 'temp-mail.org', 'temp-mail.ru',
        'tempalias.com', 'tempe-mail.com', 'tempemail.co.za', 'tempemail.com', 'tempemail.net',
        ...
        'temporarioemail.com.br', 'temporaryemail.net', 'temporaryforwarding.com', 'temporaryinbox.com', 'temporarymailaddress.com',
        'tempthe.net', 'thankyou2010.com', 'thc.st', 'thelimestones.com', 'thisisnotmyrealemail.com',
        'thismail.net', 'throwawayemailaddress.com', 'throwawaymail.com', 'tilien.com', 'tittbit.in',
        'tizi.com', 'tmailinator.com', 'toomail.biz', 'top100mail.com', 'topranklist.de',
        'tradermail.info', 'trash-mail.at', 'trash-mail.com', 'trash-mail.de', 'trash2009.com',
        'trash2010.com', 'trash-amil.com', 'trashbox.eu', 'trashdevil.com', 'trashdevil.de',
        ...
        'trashymail.net', 'trayna.com', 'trbvm.com', 'trialmail.de', 'trillianpro.com',
        'tryalert.com', 'turual.com', 'twinmail.de', 'tyldd.com', 'uggsrock.com',
        'umail.net', 'unmail.ru', 'upliftnow.com', 'uplipht.com', 'uroid.com',
        'us.af', 'venompen.com', 'veryrealemail.com', 'viditag.com', 'viewcastmedia.com',
        'viewcastmedia.net', 'viewcastmedia.org', 'viralplays.com', 'vpn.st', 'vsimcard.com',
        'vubby.com', 'vztc.com', 'wasteland.rfc822.org', 'webemail.me', 'webm4il.info',
        'webuser.in', 'wee.my', 'wefjo.grn.cc', 'weg-werf-email.de', 'wegwerf-email-addressen.de',
        'wegwerf-emails.de', 'wegwerfadresse.de', 'wegwerfemail.de', 'wegwerfmail.de', 'wegwerfmail.info',
        'wegwerfmail.net', 'wegwerfmail.org', 'welikecookies.com', 'wh4f.org', 'whyspam.me',
        'willhackforfood.biz', 'willselfdestruct.com', 'winemaven.info', 'wronghead.com', 'wuzup.net',
        'wuzupmail.net', 'wwwnew.eu', 'x.ip6.li', 'xagloo.com', 'xemaps.com',
        ...
        'yuurok.com', 'zehnminuten.de', 'zehnminutenmail.de', 'zippymail.info', 'zoemail.net',
        'zoemail.org', 'zomg.info', 'zumail.net', 'zxcv.com', 'zzz.com',
    ];
}