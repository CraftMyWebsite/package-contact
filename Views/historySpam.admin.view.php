...
<div class="grid-8 mt-6">
    <div class="w-full space-y-4">
        <a href="../history" type="button" class="w-full bg-white dark:bg-gray-600 rounded px-4 py-2 relative font-medium">
            <?= LangManager::translate("contact.antispam.inbox") ?>
        ...
        <a href="" type="button" class="w-full bg-white dark:bg-gray-600 rounded px-4 py-2 relative font-medium">
            <span class="text-blue-600"><?= LangManager::translate("contact.antispam.junk") ?></span>
    ...
    <div class="col-span-7">
        <div class="card">
            <h6><?= LangManager::translate("contact.antispam.junk") ?></h6>
                        ...
                        <?php if ($message->isSpam()): ?>
                            <tr class="<?= $message->isRead() ? "" : 'font-bold' ?>">
                                ...
                                <td class="text-center space-x-2">
                                    ...
                                    <a title="Non Spam" href="../nonSpam/<?= $message->getId() ?>"><i class="text-warning fa-solid fa-broom"></i></a>
